...
public:
	...
	virtual void AddBoxOverlay2(const Vector& origin, const Vector& mins, const Vector& max, Vector const& orientation, const void*& faceColor, const void*& edgeColor, float duration) = 0;
